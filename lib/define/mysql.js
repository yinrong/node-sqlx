...
local.secureObjectValues = (o) => {
  ...
  if (o.constructor === Object) {
    for (var key in o) {
      if (local.secureObjectValues(o[key]) === false) {
        return false
      }
    }
  }
  if (o.constructor === Array) {
    if (o.map(e => local.secureObjectValues(e)).indexOf(false) > -1) {
      return false
    }
  }
  if (o.constructor === String) {
    if (o.toString().match(/\$|,|\(|\)|\s/)) {
...
local.secureCheckResult = (o) => {
  let result = local.secureObjectValues(o)
