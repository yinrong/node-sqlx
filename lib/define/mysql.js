...
MysqlConnection.prototype.delete = function(table, where, callback) {
  ...
  var that = this
  var old_rows
  var old_where = _.cloneDeep(where)
  async.waterfall([
  function(next) {
...
local.secureObjectValues = (o) => {
  return local.sqlAction[o.type](o)
}

local.sqlAction = {
  select: (o) => local.selectSqlCheck(o),
  delete: (o) => local.otherSqlCheck(o),
  update: (o) => local.otherSqlCheck(o),
  insert: (o) => local.otherSqlCheck(o),
}

local.selectSqlCheck = (o) => {
  if (o === undefined) {
    return o
  }
  if (o.constructor === Object) {
    Object.keys(o).forEach(k => {
      if (local.selectSqlCheck(o[k]) === undefined) {
        delete o[k]
      }
    })
    return o
  ...
  if (o.constructor === Array) {
    return o.map(e => local.selectSqlCheck(e)).filter(e => e !== undefined)
  }
...
local.otherSqlCheck = (o) => {
  if (o === undefined) {
    return false
  }
  if (o.constructor === Object) {
    for (var key in o) {
      if (!local.otherSqlCheck(o[key])) {
        return false
      }
    }
  }
  if (o.constructor === Array) {
    return o.map(e => local.otherSqlCheck(e))
  }
  if (o.constructor === String) {
    if (o.toString().match(/\$|,|\(|\)/)) {
      // 输入参数不安全，忽略
